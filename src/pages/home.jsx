...
export default function Home() {
    return (
        <div className="h-full flex flex-col items-center justify-center gap-30 text-white lg:flex-row lg:gap-10">
            ...
            <div className="bg-white text-gray-800 text-2xl rounded-full w-40 h-40 flex items-center justify-center md:w-60 md:h-60 md:text-3xl lg:w-70 lg:h-70 lg:text-4xl hover:shadow-[0_0_0_50px_rgba(255,255,255,0.1)] transition-all duration-300 md:hover:shadow-[0_0_0_70px_rgba(255,255,255,0.1)]">
